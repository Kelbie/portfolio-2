...
To get started we are going to clone an Azure boilerplate for Node.js which can be found in [this GitHub repo]().
...
For more information on Azure whitelisting/blacklisting view the [official Azure documentation]().
