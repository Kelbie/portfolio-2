...
const projects: Project[] = [
  {
    ...
    description: `StudentLog is a website which allows students to find internship or new grad gobs relevant to their careers as well as using the built-in dynamic CV builder.`,
  ...
  {
    title: "Hangul.cool: Korean Typing Game",
    img: "/Korean.png",
  ...
  },
  {
    ...
    description: `A VSCode Extension with rich support for Bitcoin Script including features such as IntelliSense, linting, and code formatting`,
  ...
  return <div className={className}>
      <div className="sections">
        <Section>
          ...
          <div>
            <P>Hi, my name is Kevin Kelbie. I'm a passionate software developer who graduated from Robert Gordon University with a 1st class BSc (Hons) in Computing (Application Software Development).</P>
