...
export default styled(Gradient)`
    ...
    &.left {
        ...
        left: 4px;
				background-image: linear-gradient(to right, hsl(211, 35%, 13%), hsla(211, 35%, 13%, 0));
				height: 100vh;
    }
    &.right {
				position: fixed;
		...
		&.top {
			...
			height: 100px;
			top: 0px;
			background-image: linear-gradient(to bottom, hsl(211, 35%, 13%), hsla(211, 35%, 13%, 1), hsla(211, 35%, 13%,0.5));
		}
`;
